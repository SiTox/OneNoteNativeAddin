...
typedef
	IDispatchImpl<IDTExtensibility2, &__uuidof(IDTExtensibility2), &__uuidof(__AddInDesignerObjects), 1, 0>
	IDTExtensibilityImpl;


/*------------------------------------------------------------------------------
	CConnect class - what OneNote uses to communicate with an add-in
------------------------------------------------------------------------------*/
